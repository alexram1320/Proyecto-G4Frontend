        ...
        <div class="layout-topbar">
            ...
            <div class="layout-topbar-actions">
                ...
                @if (autenticacion.usuario(); as usuario) {
                    ...
                    <a
                        routerLink="/perfil"
                        class="hidden md:flex items-center gap-3 px-3 py-2 rounded-lg bg-surface-100 dark:bg-surface-800 no-underline text-color"
                        aria-label="Ver perfil del usuario conectado"
                    >
