...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, MatBadgeModule],
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            <button class="layout-menu-button layout-topbar-action" (click)="layoutService.onMenuToggle()">
                <i class="pi pi-bars"></i>
            </button>
            <a class="layout-topbar-logo" routerLink="/panel">
        ...
        <div class="layout-topbar-actions">
            @if (autenticacion.usuario(); as usuario) {
                <a routerLink="/perfil" class="hidden md:flex items-center gap-3 px-3 py-2 rounded-lg bg-surface-100 dark:bg-surface-800 no-underline text-color" aria-label="Ver perfil del usuario conectado">
                    <i class="pi pi-user text-primary"></i>
                    <div class="flex flex-col leading-tight">
                        <span class="font-semibold">{{ usuario.nombre }}</span>
                        <small class="text-muted-color">{{ etiquetaRol(usuario.rol) }}</small>
                    </div>
                </a>
            }
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    <button type="button" class="layout-topbar-action" routerLink="/auth/login">
                        ...
                        <span>{{ autenticacion.usuario()?.nombre ?? 'Iniciar sesión' }}</span>
                    </button>
                    <button
                        type="button"
                        class="layout-topbar-action"
                        (click)="autenticacion.cerrarSesion()"
                        *ngIf="autenticacion.autenticado()"
                    >
